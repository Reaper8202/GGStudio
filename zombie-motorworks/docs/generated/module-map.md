...
- Source Modules: 109
- Source lines: 44,077
- Test files scanned: 94

## Largest Modules

| Module | LOC |
| --- | ---: |
| [`src/survival/SurvivalMode.ts`](../../src/survival/SurvivalMode.ts) | 3440 |
| [`src/vfx/VfxSystem.ts`](../../src/vfx/VfxSystem.ts) | 2858 |
| [`src/survival/zombies/Zombie.ts`](../../src/survival/zombies/Zombie.ts) | 2492 |
| [`src/editor/EditorMode.ts`](../../src/editor/EditorMode.ts) | 2213 |
| [`src/editor/ui.ts`](../../src/editor/ui.ts) | 2143 |
| [`src/survival/zombies/ZombieSystem.ts`](../../src/survival/zombies/ZombieSystem.ts) | 1459 |
| [`src/app/App.ts`](../../src/app/App.ts) | 1353 |
| [`src/editor/parts/upgradeKit.ts`](../../src/editor/parts/upgradeKit.ts) | 1221 |
| [`src/runtime/vehicle.ts`](../../src/runtime/vehicle.ts) | 1118 |
...
### [`src/core/score.ts`](../../src/core/score.ts) (53 LOC)
...
### [`src/core/types.ts`](../../src/core/types.ts) (512 LOC)
...
### [`src/runtime/vehicle.ts`](../../src/runtime/vehicle.ts) (1118 LOC)
...
### [`src/runtime/wheels.ts`](../../src/runtime/wheels.ts) (453 LOC)
...
### [`src/survival/SurvivalMode.ts`](../../src/survival/SurvivalMode.ts) (3440 LOC)
...
### [`src/survival/devtuning/DevTunerPanel.ts`](../../src/survival/devtuning/DevTunerPanel.ts) (766 LOC)
...
### [`src/survival/devtuning/DevTuning.ts`](../../src/survival/devtuning/DevTuning.ts) (325 LOC)
...
### [`src/survival/waveBalance.ts`](../../src/survival/waveBalance.ts) (151 LOC)
...
### [`src/survival/zombies/IceTrail.ts`](../../src/survival/zombies/IceTrail.ts) (141 LOC)
...
### [`src/survival/zombies/Zombie.ts`](../../src/survival/zombies/Zombie.ts) (2492 LOC)
...
### [`src/survival/zombies/ZombieSystem.ts`](../../src/survival/zombies/ZombieSystem.ts) (1459 LOC)

- Exports: `ZombieDamageReport`, `ZombieHitResult`, `ZombieSystem`
- Imports: `src/core/grid.ts`, `src/core/mass.ts`, `src/core/turretModules.ts`, `src/core/types.ts`, `src/runtime/assembler.ts`, `src/runtime/vehicle.ts`, `src/survival/devtuning/DevTuning.ts`, `src/survival/zombies/IceTrail.ts`, `src/survival/zombies/Landmines.ts`, `src/survival/zombies/ThrowerProjectiles.ts`, `src/survival/zombies/Zombie.ts`, `src/survival/zombies/zombieConfig.ts`, `src/vfx/VfxSystem.ts`
...
### [`src/vfx/VfxSystem.ts`](../../src/vfx/VfxSystem.ts) (2858 LOC)
